...
go test ./internal/proxy -count=1 -run 'TestToolProtocolContract|TestVisualStudioToolExecutionE2E|TestCopilotToolCatalog|TestKnownCopilot|TestCanonicalToolName|TestNormalize.*RunTests|TestProbeOpenAIStreamForDSML|TestStreamOpenAI.*Tool|TestStreamOpenAI.*Undeclared|TestOpenAIStreamFallback|TestParseOpenAIStreamPayloadConvertsLegacy|TestPayloadTooLargeHint|Test.*DSML|Test.*Dsml'
